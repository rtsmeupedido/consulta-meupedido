export const options = [
  {
    ...
    children: [
      ...
      { value: "3", label: "Sem retorno de acareação no prazo transportadora" },
      {
        value: "4",
        label:
          "Pedido sendo/ou devolvido pela transportadora - formalizado no rastreio",
      },
      {
        value: "5",
        label:
          "Transportadora informou que vai devolver pedido porém ainda sem atualização no rastreio",
      },
      {
        value: "6",
    ...
    children: [
      {
        value: "1",
        label:
          "Total - Cancelamento solicitado por loja ou CD após o faturamento",
      },
      {
        value: "2",
        label:
          "Parcial - Cancelamento solicitado por loja ou CD após o faturamento",
      },
    ],
  },
  {
